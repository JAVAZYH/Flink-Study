...
//        val in2 = ListData2.get.iterator().hasNext
...
//                //如果第二条流的数据到达
//          //将两条数据成功组合
//          val in2It=ListData2.get.iterator()
//          while (in2It.hasNext ){
//            val in2=in2It.next()
//            out.collect("process ele1 join>>>>>"+in1+in2)
//          }
//
//          //删除第一条流的定时器和缓存的数据
...
//        else {
//          ListData2.add(in2)
//          //把第二条流中之前的所有数据都取出，然后进行进行关联
//          val it: util.Iterator[String] = ListData2.get().iterator
//          while (it.hasNext()){
//            val in2=it.next()
//            out.collect("process ele2 join>>>>>"+in1+in2)
//          }
//
//
//          //把第二条数据流之前注册过的定时器都删除
